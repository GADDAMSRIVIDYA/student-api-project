...
//         const students = await readStudentsFromFile(); // ✅ await added
...
// import { readStudentsFromFile, Student } from "./helpers";

// export async function addStudentValidation(
//   req: Request,
//   res: Response,
//   next: NextFunction
// ) {
...
// export async function updateStudentValidation(
//   req: Request,
//   res: Response,
//   next: NextFunction
// ) {
...
//     (req as any).students = students;
//     (req as any).studentIndex = studentIndex;
//     next();
//   } catch (err) {
//     console.error("Error in updateStudentValidation:", err);
//     res
...
import { Request, Response, NextFunction } from "express";
import { readStudentsFromFile } from "./helpers";
